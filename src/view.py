...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.summary_radioButton = QtWidgets.QRadioButton(self.verticalLayoutWidget)
        self.summary_radioButton.setObjectName("summary_radioButton")
        self.verticalLayout.addWidget(self.summary_radioButton)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.summary_radioButton.setText(_translate("Dialog", "Summary"))
